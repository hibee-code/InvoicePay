...
export class Sh1757341289808 implements MigrationInterface {
    name = 'Sh1757341289808'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_b485ad884cd5182b8ba80f0331" ON "business" ("businessName") `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_b485ad884cd5182b8ba80f0331"`);
